#!/usr/bin/env sh
#
# Copyright 2025 [Tu Nombre o Nombre de tu Proyecto]
#
# Portions of this script are derived from code licensed under the
...
#
# No modifications were made by Mario Garcia Carbonero in 2025.
