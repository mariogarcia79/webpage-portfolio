...
import { MIN_NAME_LENGTH, MAX_NAME_LENGTH, MIN_EMAIL_LENGTH, MAX_EMAIL_LENGTH, MIN_PASSWORD_LENGTH, MAX_PASSWORD_LENGTH } from '../config/validation';
...
export function validateInput(content, isMd, maxLen) {
    if (!content)
...
export function sanitizeMongoInput(str) {
    if (!str)
        return '';
